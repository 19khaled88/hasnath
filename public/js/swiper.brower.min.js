...
function updateSize() {
  ...
  ;(t =
    ...
    (0 === t && e.isHorizontal()) ||
      ...
      ((t =
        t -
        parseInt(elementStyle(a, 'padding-left') || 0, 10) -
        parseInt(elementStyle(a, 'padding-right') || 0, 10)),
      (s =
        s -
        parseInt(elementStyle(a, 'padding-top') || 0, 10) -
        parseInt(elementStyle(a, 'padding-bottom') || 0, 10)),
      Number.isNaN(t) && (t = 0),
      Number.isNaN(s) && (s = 0),
...
function updateSlides() {
  ...
  const a = e.params,
    ...
    p = elementChildren(r, `.${e.params.slideClass}, swiper-slide`),
  ...
  'string' == typeof y &&
    ...
    a.centeredSlides &&
      a.cssMode &&
      (setCSSProperty(i, '--swiper-centered-offset-before', ''),
      setCSSProperty(i, '--swiper-centered-offset-after', ''))
  ...
  for (let i = 0; i < u; i += 1) {
    ...
    if (
      ((M = 0),
      p[i] && (r = p[i]),
      T && e.grid.updateSlide(i, r, u, t),
      !p[i] || 'none' !== elementStyle(r, 'display'))
    ) {
      if ('auto' === a.slidesPerView) {
        ...
        if (
          ...
          M = e.isHorizontal()
            ? elementOuterSize(r, 'width', !0)
            : elementOuterSize(r, 'height', !0)
        else {
          const e = s(n, 'width'),
            t = s(n, 'padding-left'),
            a = s(n, 'padding-right'),
        ...
        (M = (n - (a.slidesPerView - 1) * y) / a.slidesPerView),
          a.roundLengths && (M = Math.floor(M)),
          p[i] && (p[i].style[t('width')] = `${M}px`)
      p[i] && (p[i].swiperSlideSize = M),
        h.push(M),
        a.centeredSlides
          ? ((E = E + M / 2 + S / 2 + y),
            0 === S && 0 !== i && (E = E - n / 2 - y),
  ...
  if (
    ...
    T && e.grid.updateWrapperSize(M, m, t),
    !a.centeredSlides)
  ) {
    const t = []
  ...
  if (d && a.loop) {
    ...
    for (let s = 0; s < e.virtual.slidesBefore + e.virtual.slidesAfter; s += 1)
      1 === a.slidesPerGroup && m.push(m[m.length - 1] + t),
  ...
  if (
    ...
    setCSSProperty(i, '--swiper-centered-offset-before', -m[0] + 'px'),
      setCSSProperty(
        i,
...
function updateSlidesClasses() {
  const e = this,
    ...
    n = (e) => elementChildren(a, `.${s.slideClass}${e}, swiper-slide${e}`)[0]
  let l
  if (
    (t.forEach((e) => {
  ...
  if (l) {
    ...
    let e = elementNextAll(l, `.${s.slideClass}, swiper-slide`)[0]
    s.loop && !e && (e = t[0]), e && e.classList.add(s.slideNextClass)
    let a = elementPrevAll(l, `.${s.slideClass}, swiper-slide`)[0]
...
function updateActiveIndex(e) {
  ...
  if ((void 0 === d && (d = getActiveIndexByTranslate(t)), a.indexOf(s) >= 0))
    o = a.indexOf(s)
  else {
...
function transitionEnd(e, t) {
  ...
  ;(s.animating = !1),
    a.cssMode ||
      (s.setTransition(0),
      transitionEmit({ swiper: s, runCallbacks: e, direction: t, step: 'End' }))
}
var transition = {
    ...
    ;(i = parseInt(e.clickedSlide.getAttribute('data-swiper-slide-index'), 10)),
      t.centeredSlides
        ? r < e.loopedSlides - a / 2 ||
          ...
          ? (e.loopFix(),
            (r = elementIndex(
              elementChildren(s, `${n}[data-swiper-slide-index="${i}"]`)[0],
            )),
            nextTick(() => {
              e.slideTo(r)
            }))
...
function loopCreate(e) {
  ...
  elementChildren(a, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
...
function onTouchStart(e) {
  ...
  if (r.noSwiping && (m ? closestElement(u, d) : d.closest(u)))
  ...
  d.matches(i.focusableElements) &&
    ((w = !1), 'SELECT' === d.nodeName && (i.isTouched = !1)),
    s.activeElement &&
...
function onTouchMove(e) {
  ...
  const d = a.evCache.findIndex((e) => e.pointerId === o.pointerId)
  d >= 0 && (a.evCache[d] = o)
  const c = a.evCache.length > 1 ? a.evCache[0] : o,
    p = c.pageX,
    u = c.pageY
  if (o.preventedByNestedSwiper) return (r.startX = p), void (r.startY = u)
  if (!s.allowTouchMove)
    return (
      o.target.matches(a.focusableElements) || (s.allowClick = !1),
      void (
        a.isTouched &&
        (Object.assign(r, {
          startX: p,
  ...
  if (
    ...
    o.target.matches(a.focusableElements)
  )
        ...
        a.currentTranslate > s.minTranslate() &&
          ...
          i.resistance &&
            (a.currentTranslate =
              s.minTranslate() -
              1 +
              (-s.minTranslate() + a.startTranslate + h) ** E)))
      : h < 0 &&
        (w &&
          !b &&
          a.currentTranslate <
        ...
        a.currentTranslate < s.maxTranslate() &&
          ...
          i.resistance &&
            (a.currentTranslate =
              s.maxTranslate() +
              1 -
              (s.maxTranslate() - a.startTranslate - h) ** E))),
...
function onTouchEnd(e) {
  ...
  if (p > i.longSwipesMs) {
    ...
    'next' === t.swipeDirection &&
      (v >= i.longSwipesRatio
        ? t.slideTo(i.rewind && t.isEnd ? h : m + w)
        : t.slideTo(m)),
...
const events = (e, t) => {
  ...
  i[o]('pointerdown', e.onTouchStart, { passive: !1 }),
    ...
    a.cssMode && r[o]('scroll', e.onScroll),
...
class Swiper {
  constructor() {
    ...
    const o = extend({}, defaults, l)
    return (
      (n.params = extend({}, o, extendedDefaults, t)),
      (n.originalParams = extend({}, n.params)),
      (n.passedParams = extend({}, t)),
      n.params &&
        n.params.on &&
  ...
  mount(e) {
    ...
    return (
      !i &&
        ...
        ((i = createElement('div', t.params.wrapperClass)),
        s.append(i),
        elementChildren(s, `.${t.params.slideClass}`).forEach((e) => {
          i.append(e)
        })),
      Object.assign(t, {
        el: s,
  ...
  destroy(e, t) {
    ...
    return (
      void 0 === s.params ||
        ...
        !1 !== e && ((s.el.swiper = null), deleteProps(s)),
        (s.destroyed = !0)),
      null
    )
  }
...
function Virtual(e) {
    ...
    return (
      a.renderSlide
        ? ((i = a.renderSlide.call(s, e, t)),
          'string' == typeof i && ((l.innerHTML = i), (i = l.children[0])))
        : (i = s.isElement
            ? createElement('swiper-slide')
            : createElement('div', s.params.slideClass)),
  ...
  function d(e) {
    const {
      ...
      { addSlidesBefore: l, addSlidesAfter: d } = s.params.virtual,
    ...
    ;(g = s.rtlTranslate ? 'right' : s.isHorizontal() ? 'left' : 'top'),
      i
        ? ((v = Math.floor(t / 2) + a + d), (w = Math.floor(t / 2) + a + l))
        : ((v = t + (a - 1) + d), (w = (n ? t : a) + l))
    let b = h - w,
      y = h + v
    n || ((b = Math.max(b, 0)), (y = Math.min(y, u.length - 1)))
    let E = (s.slidesGrid[b] || 0) - (s.slidesGrid[0] || 0)
    function S() {
      s.updateSlides(),
        s.updateProgress(),
        s.updateSlidesClasses(),
    ...
    if (
      (n && h >= w
        ? ((b -= w), i || (E += s.slidesGrid[0]))
        : n && h < w && ((b = -w), i && (E += s.slidesGrid[0])),
    ...
    for (let t = C; t < P; t += 1)
      if (t >= b && t <= y) {
        const s = M(t)
        void 0 === p || e ? T.push(s) : (t > p && T.push(s), t < c && x.push(s))
      }
    if (
      (T.forEach((e) => {
    ...
    elementChildren(s.slidesEl, '.swiper-slide, swiper-slide').forEach((e) => {
      e.style[g] = `${E}px`
    }),
      S()
  }
...
function Keyboard(e) {
  ...
  function l(e) {
    ...
    if (
      ...
      if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || f)) {
        let e = !1
        if (
          elementParents(t.el, `.${t.params.slideClass}, swiper-slide`).length >
            0 &&
          0 === elementParents(t.el, `.${t.params.slideActiveClass}`).length
        )
          return
        const a = t.el,
          i = a.clientWidth,
  ...
  function o() {
    t.keyboard.enabled ||
      (r.addEventListener('keydown', l), (t.keyboard.enabled = !0))
  }
  function d() {
    t.keyboard.enabled &&
      (r.removeEventListener('keydown', l), (t.keyboard.enabled = !1))
  }
...
function Mousewheel(e) {
  ...
  function m(e) {
    ...
    if (0 === p) return !0
    r.invert && (p = -p)
    let h = t.getTranslate() + p * r.sensitivity
    if (
      ...
      const e = { time: now(), delta: Math.abs(p), direction: Math.sign(p) },
        a =
          l &&
          e.time < l.time + 500 &&
          e.delta <= l.delta &&
  ...
  a('init', () => {
    ...
    Object.assign(t.mousewheel, { enable: h, disable: g })
}
  ...
  return (
    e.params.createElements &&
      Object.keys(a).forEach((i) => {
        if (!s[i] && !0 === s.auto) {
          let r = elementChildren(e.el, `.${a[i]}`)[0]
          r ||
            ((r = createElement('div', a[i])),
            (r.className = a[i]),
            e.el.append(r)),
            (s[i] = r),
            (t[i] = r)
...
function Pagination(e) {
  ...
  function p(e) {
    ...
    if (!s) return
    e.preventDefault()
    const a = elementIndex(s) * t.params.slidesPerGroup
  ...
  function u() {
    ...
    r.forEach((e, r) => {
      if (
        ('fraction' === s.type &&
          (e
            .querySelectorAll(classesToSelector(s.currentClass))
            .forEach((e) => {
              e.textContent = s.formatFractionCurrent(a + 1)
            }),
          e.querySelectorAll(classesToSelector(s.totalClass)).forEach((e) => {
        ...
        'horizontal' === i ? (n = r) : (l = r),
          e
            .querySelectorAll(classesToSelector(s.progressbarFillClass))
            .forEach((e) => {
    ...
    'fraction' === e.type &&
      ...
      a.forEach((s) => {
        'custom' !== e.type && (s.innerHTML = r || ''),
          'bullets' === e.type &&
            (t.pagination.bullets = [
              ...s.querySelectorAll(classesToSelector(e.bulletClass)),
            ])
      }),
    ...
    'string' == typeof e.el &&
      ...
      s &&
        ...
        (t.params.uniqueNavElements &&
          ...
          s.length > 1 &&
            (s = s.filter((e) => elementParents(e, '.swiper')[0] === t.el)[0])),
...
function Scrollbar(e) {
    ...
    s
      ...
      t.isHorizontal()
        ? ((a.style.transform = `translate3d(${c}px, 0, 0)`),
          (a.style.width = `${d}px`))
        : ((a.style.transform = `translate3d(0px, ${c}px, 0)`),
          (a.style.height = `${d}px`)),
      r.hide &&
        (clearTimeout(p),
        (i.style.opacity = 1),
  ...
  function f() {
    ...
    ;(s.style.width = ''),
      (s.style.height = ''),
      (o = t.isHorizontal() ? a.offsetWidth : a.offsetHeight),
      (d =
        t.size /
        (t.virtualSize +
  ...
  function g(e) {
    ...
    ;(r =
      (h(e) -
        elementOffset(i)[t.isHorizontal() ? 'left' : 'top'] -
        (null !== n ? n : l / 2)) /
      (o - l)),
  ...
  function E() {
    ...
    'string' == typeof a.el &&
      ...
      i &&
        ((n = i.querySelector(`.${t.params.scrollbar.dragClass}`)),
        n ||
          ((n = createElement('div', t.params.scrollbar.dragClass)),
          i.append(n))),
      Object.assign(e, { el: i, dragEl: n }),
...
function Zoom(e) {
    ...
    if (((n = !1), (l = !1), c.push(e), !(c.length < 2))) {
      if (((n = !0), (p.scaleStart = h()), !p.slideEl)) {
        ...
        if (
          ...
          (p.imageEl = a),
          (p.imageWrapEl = a
            ? elementParents(p.imageEl, `.${s.containerClass}`)[0]
            : void 0),
          !p.imageWrapEl)
        )
          return void (p.imageEl = void 0)
        p.maxRatio =
          p.imageWrapEl.getAttribute('data-swiper-zoom') || s.maxRatio
      }
      if (p.imageEl) {
        const [e, t] = (function () {
        ...
        ;(p.imageEl.style.transformOrigin = `${e}px ${t}px`),
  ...
  function y(e) {
    ...
    u.isMoved ||
      ...
      (u.startX = getTranslate(p.imageWrapEl, 'x') || 0),
      (u.startY = getTranslate(p.imageWrapEl, 'y') || 0),
    ...
    if (!(a < p.slideWidth && i < p.slideHeight)) {
      if (
        ...
        (u.maxY = -u.minY),
        (u.touchesCurrent.x = c.length > 0 ? c[0].pageX : e.pageX),
        (u.touchesCurrent.y = c.length > 0 ? c[0].pageY : e.pageY),
        !u.isMoved && !d)
      ) {
        if (
          t.isHorizontal() &&
      ...
      e.cancelable && e.preventDefault(),
        ...
        (m.x =
          (u.touchesCurrent.x - m.prevPositionX) /
          (Date.now() - m.prevTime) /
          2),
        (m.y =
          (u.touchesCurrent.y - m.prevPositionY) /
          (Date.now() - m.prevTime) /
          2),
  ...
  function S(e) {
    ...
    if (!p.slideEl) {
      e &&
        e.target &&
        (p.slideEl = e.target.closest(`.${t.params.slideClass}, swiper-slide`)),
        p.slideEl ||
          (t.params.virtual && t.params.virtual.enabled && t.virtual
            ? (p.slideEl = elementChildren(
                t.slidesEl,
      ...
      s &&
        ...
        (p.imageEl = s),
        (p.imageWrapEl = s
          ? elementParents(p.imageEl, `.${a.containerClass}`)[0]
          : void 0)
    }
    if (!p.imageEl || !p.imageWrapEl) return
    let i, n, l, d, c, m, f, h, g, v, w, b, y, E, S, x, T, M
    t.params.cssMode &&
      ((t.wrapperEl.style.overflow = 'hidden'),
    ...
    1 === o && C && ((i = void 0), (n = void 0)),
      (s.scale =
        C || p.imageWrapEl.getAttribute('data-swiper-zoom') || a.maxRatio),
      (o = C || p.imageWrapEl.getAttribute('data-swiper-zoom') || a.maxRatio),
      !e || (1 === o && C)
        ? ((f = 0), (h = 0))
        : ((T = p.slideEl.offsetWidth),
          (M = p.slideEl.offsetHeight),
          (l = elementOffset(p.slideEl).left + r.scrollX),
          (d = elementOffset(p.slideEl).top + r.scrollY),
          (c = l + T / 2 - i),
          (m = d + M / 2 - n),
  ...
  function x() {
    ...
    if (!p.slideEl) {
      t.params.virtual && t.params.virtual.enabled && t.virtual
        ...
        : (p.slideEl = t.slides[t.activeIndex])
      let e = p.slideEl.querySelector(`.${s.containerClass}`)
      e &&
  ...
  function C() {
    ...
    if (e.enabled) return
    e.enabled = !0
    const { passiveListener: s, activeListenerWithCapture: a } = M()
    t.wrapperEl.addEventListener('pointerdown', v, s),
  ...
  function P() {
    ...
    e.enabled = !1
    const { passiveListener: s, activeListenerWithCapture: a } = M()
    t.wrapperEl.removeEventListener('pointerdown', v, s),
  ...
  Object.defineProperty(t.zoom, 'scale', {
        ...
        (function (e) {
          ...
          p.imageEl &&
            (u.isTouched ||
              ...
              (u.isTouched = !0),
              (u.touchesStart.x = e.pageX),
              (u.touchesStart.y = e.pageY)))
        })(s)
    }),
    a('touchEnd', (e, s) => {
      t.zoom.enabled &&
        (function () {
          ...
          const i = m.x * s,
            ...
            n = m.y * a,
            l = u.currentY + n
          0 !== m.x && (s = Math.abs((r - u.currentX) / m.x)),
            0 !== m.y && (a = Math.abs((l - u.currentY) / m.y))
          ...
          ;(u.minX = Math.min(p.slideWidth / 2 - d / 2, 0)),
            ...
            (p.imageWrapEl.style.transitionDuration = `${o}ms`),
            (p.imageWrapEl.style.transform = `translate3d(${u.currentX}px, ${u.currentY}px,0)`)
        })()
    }),
    a('doubleTap', (e, s) => {
    ...
    Object.assign(t.zoom, { enable: C, disable: P, in: S, out: x, toggle: T })
}
        ...
        function n(s) {
          s.setTransition(e, t),
            0 !== e &&
              ...
              elementTransitionEnd(s.wrapperEl, () => {
                i && s.transitionEnd()
              }))
        }
        if (Array.isArray(i))
...
function A11y(e) {
  ...
  function f(e) {
    ...
    ;(t.pagination &&
      ...
      !e.target.matches(classesToSelector(t.params.pagination.bulletClass))) ||
      (t.navigation &&
        t.navigation.nextEl &&
      ...
      t.pagination &&
        a.matches(classesToSelector(t.params.pagination.bulletClass)) &&
        a.click())
  }
  function h() {
  ...
  a('beforeInit', () => {
    ;(i = createElement('span', t.params.a11y.notificationClass)),
        ...
        if (e) {
          ...
          for (let a = 0, i = t.slides.length; a < i; a += 1) {
            ...
            if (
              ...
              const e = elementIndex(i)
              t.slideTo(e, s, t.params.runCallbacksOnInit, !0)
            }
          }
        }
        t.params.hashNavigation.watchState &&
          l.addEventListener('hashchange', o)
      })()
  }),
    i('destroy', () => {
      t.params.hashNavigation.enabled &&
...
function Autoplay(e) {
  let t,
    s,
    { swiper: a, extendParams: i, on: r, emit: n, params: l } = e
  ...
  function w(e) {
    a &&
      ...
      (a.wrapperEl.removeEventListener('transitionend', w), T())
  }
  const b = () => {
      if (a.destroyed || !a.autoplay.running) return
      a.autoplay.paused ? (d = !0) : d && ((g = o), (d = !1))
      const e = a.autoplay.paused ? o : v + g - new Date().getTime()
      ;(a.autoplay.timeLeft = e),
        n('autoplayTimeLeft', e, e / h),
    ...
    y = (e) => {
      ...
      !Number.isNaN(r) && r > 0 && void 0 === e && ((i = r), (h = r), (g = r)),
        (o = i)
      const l = a.params.speed,
        d = () => {
          a &&
            !a.destroyed &&
    ...
    x = (e, s) => {
      ...
      if (((a.autoplay.paused = !0), s))
        return m && (o = a.params.autoplay.delay), (m = !1), void i()
      const r = o || a.params.autoplay.delay
      ;(o = r - (new Date().getTime() - v)),
        (a.isEnd && o < 0 && !a.params.loop) || (o < 0 && (o = 0), i())
    },
    T = () => {
      ;(a.isEnd && o < 0 && !a.params.loop) ||
        a.destroyed ||
        !a.autoplay.running ||
        ((v = new Date().getTime()),
        f ? ((f = !1), y(o)) : y(),
  ...
  r('init', () => {
    a.params.autoplay.enabled &&
      ...
      getDocument().addEventListener('visibilitychange', M),
      (v = new Date().getTime()),
      E())
  }),
    r('destroy', () => {
      a.el.removeEventListener('pointerenter', C),
        ...
        getDocument().removeEventListener('visibilitychange', M),
        a.autoplay.running && S()
    }),
    r('beforeTransitionStart', (e, t, s) => {
      !a.destroyed &&
        a.autoplay.running &&
        (s || !a.params.autoplay.disableOnInteraction ? x(!0, !0) : S())
    }),
    r('sliderFirstMove', () => {
      !a.destroyed &&
        a.autoplay.running &&
    ...
    Object.assign(a.autoplay, { start: E, stop: S, pause: x, resume: T })
}
function Thumb(e) {
  let { swiper: t, extendParams: s, on: a } = e
  s({
            ...
            a = () => {
              const a =
                'string' == typeof e.swiper
                  ...
                  : e.swiper
              if (a && a.swiper) (e.swiper = a.swiper), l(), o(!0)
              else if (a) {
                const s = (i) => {
                  ;(e.swiper = i.detail[0]),
...
function Grid(e) {
  ...
  i.grid = {
    ...
    updateSlide: (e, r, n, l) => {
      ...
      r.style[l('margin-top')] = 0 !== f ? d && `${d}px` : ''
    },
    ...
    setTranslate: () => {
      ...
      for (let a = 0; a < e.length; a += 1) {
        ...
        const n = t.params.fadeEffect.crossFade
          ...
          l = effectTarget(s, e)
        ;(l.style.opacity = n),
          (l.style.transform = `translate3d(${i}px, ${r}px, 0px)`)
      }
    },
    setTransition: (e) => {
      const s = t.slides.map((e) => getSlideTransformEl(e))
      s.forEach((t) => {
...
function EffectCube(e) {
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      c.shadow &&
        (p
          ? ((m = t.slidesEl.querySelector('.swiper-cube-shadow')),
            m ||
              ((m = createElement('div', 'swiper-cube-shadow')),
              t.slidesEl.append(m)),
            (m.style.height = `${r}px`))
          : ((m = e.querySelector('.swiper-cube-shadow')),
            m ||
              ((m = createElement('div', 'swiper-cube-shadow')), e.append(m))))
      for (let e = 0; e < a.length; e += 1) {
        const t = a[e]
        let s = e
        ...
        const v = `rotateX(${p ? 0 : -r}deg) rotateY(${
          p ? r : 0
        }deg) translate3d(${m}px, ${h}px, ${g}px)`
        d <= 1 &&
          d > -1 &&
      ...
      const h = (d.isSafari || d.isWebView) && d.needPerspectiveFix ? -o / 2 : 0
      ;(s.style.transform = `translate3d(0px,0,${h}px) rotateX(${
        t.isHorizontal() ? 0 : f
...
function createShadow(e, t, s) {
  ...
  return (
    r ||
      ((r = createElement('div', 'swiper-slide-shadow' + (s ? `-${s}` : ''))),
      i.append(r)),
    r
  )
}
  ...
  const i = (e, s, a) => {
    let i = t.isHorizontal()
      ...
      r = t.isHorizontal()
        ? e.querySelector('.swiper-slide-shadow-right')
        : e.querySelector('.swiper-slide-shadow-bottom')
    i || (i = createShadow(a, e, t.isHorizontal() ? 'left' : 'top')),
      r || (r = createShadow(a, e, t.isHorizontal() ? 'right' : 'bottom')),
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let e = 0, t = a.length; e < t; e += 1) {
        ...
        if (
          ((effectTarget(r, t).style.transform = b),
          ...
          e || (e = createShadow(r, t, n ? 'left' : 'top')),
            s || (s = createShadow(r, t, n ? 'right' : 'bottom')),
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < e.length; s += 1) {
        ...
        d < 0 ? ((h = r.next), (f = !0)) : d > 0 && ((h = r.prev), (f = !0)),
          u.forEach((e, t) => {
            u[t] = `calc(${e}px + (${i(h.translate[t])} * ${Math.abs(d * n)}))`
          }),
          m.forEach((e, t) => {
        ...
        if ((f && h.shadow) || !f) {
          ...
          if ((!e && h.shadow && (e = createShadow(r, a)), e)) {
            const t = r.shadowPerProgress ? d * (1 / r.limitProgress) : d
            e.style.opacity = Math.min(Math.max(Math.abs(t), 0), 1)
          }
        }
        const E = effectTarget(r, a)
        ;(E.style.transform = y),
          (E.style.opacity = b),
          h.origin && (E.style.transformOrigin = b)
      }
    },
    setTransition: (e) => {
      const s = t.slides.map((e) => getSlideTransformEl(e))
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let l = 0; l < e.length; l += 1) {
        ...
        const E = c < 0 ? '' + (1 + (1 - h) * c) : '' + (1 - (1 - h) * c),
          S = `\n        translate3d(${u}, ${m}, ${f}px)\n        rotateZ(${
            a.rotate ? g : 0
          }deg)\n        scale(${E})\n      `
        if (a.slideShadows) {
          let e = o.querySelector('.swiper-slide-shadow')
          e || (e = createShadow(a, o)),
            e &&
